...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-6195754c><div class="fixed left-0 right-0 spotlight z-10" data-v-6195754c></div><div class="max-w-520px text-center z-20" data-v-6195754c><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-6195754c>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-6195754c>${ssrInterpolate(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-6195754c>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6195754c"]]);

export { error404 as default };
//# sourceMappingURL=error-404-d6294444.mjs.map
